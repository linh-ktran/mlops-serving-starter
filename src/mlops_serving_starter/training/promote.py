"""Manage model lifecycle: promote models through stages using MLflow aliases.

Usage:
    # List all versions of the registered model
    .venv/bin/python -m mlops_serving_starter.training.promote --list

    # Promote a specific version to staging
    .venv/bin/python -m mlops_serving_starter.training.promote --version 4 --alias staging

    # Promote to production
    .venv/bin/python -m mlops_serving_starter.training.promote --version 4 --alias production

    # Compare metrics of all versions
    .venv/bin/python -m mlops_serving_starter.training.promote --compare
"""
...
def main() -> None:
    ...
    parser.add_argument("--alias", choices=["staging", "production", "champion", "challenger"],
